...
- (void)failedTransaction:(SKPaymentTransaction *)transaction {
    ...
    HGBLog(@"transaction.error.code = %ld", transaction.error.code);
...
- (void)checkIAPFiles{
    ...
    if (error == nil) {
        ...
        HGBLog(@"AppStoreInfoLocalFilePath error:%@", [error domain]);
    }
}
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(purchaseFailedWithErrorCode:andWithErrorInfo:)]) {
        switch (code) {
            case HGBPurchase_FILEDCOED_APPLECODE:{
                HGBLog(@"苹果返回错误信息");
                [self.delegate purchaseFailedWithErrorCode:HGBPurchase_FILEDCOED_APPLECODE andWithErrorInfo:@{ReslutCode:@(HGBPurchase_FILEDCOED_APPLECODE),ReslutMessage:@"苹果返回错误信息"}];
                break;
            }
            ...
            case HGBPurchase_FILEDCOED_NORIGHT:{
                 HGBLog(@"用户禁止应用内付费购买");
                [self.delegate purchaseFailedWithErrorCode:HGBPurchase_FILEDCOED_NORIGHT andWithErrorInfo:@{ReslutCode:@(HGBPurchase_FILEDCOED_NORIGHT),ReslutMessage:@"用户禁止应用内付费购买"}];
                break;
            }
            ...
            case HGBPurchase_FILEDCOED_EMPTYGOODS:{
                 HGBLog(@"商品为空");
                [self.delegate purchaseFailedWithErrorCode:HGBPurchase_FILEDCOED_EMPTYGOODS andWithErrorInfo:@{ReslutCode:@(HGBPurchase_FILEDCOED_EMPTYGOODS),ReslutMessage:@"商品为空"}];
                break;
            }
            ...
            case HGBPurchase_FILEDCOED_CANNOTGETINFORMATION:{
                 HGBLog(@"无法获取产品信息，请重试");
                [self.delegate purchaseFailedWithErrorCode:HGBPurchase_FILEDCOED_CANNOTGETINFORMATION andWithErrorInfo:@{ReslutCode:@(HGBPurchase_FILEDCOED_CANNOTGETINFORMATION),ReslutMessage:@"无法获取产品信息，请重试"}];
                break;
            }
            ...
            case HGBPurchase_FILEDCOED_BUYFILED:{
                HGBLog(@"购买失败，请重试");
                [self.delegate purchaseFailedWithErrorCode:HGBPurchase_FILEDCOED_BUYFILED andWithErrorInfo:@{ReslutCode:@(HGBPurchase_FILEDCOED_BUYFILED),ReslutMessage:@"购买失败，请重试"}];
                break;
            }
            ...
            case HGBPurchase_FILEDCOED_USERCANCEL:{
                 HGBLog(@"用户取消交易");
                [self.delegate purchaseFailedWithErrorCode:HGBPurchase_FILEDCOED_USERCANCEL andWithErrorInfo:@{ReslutCode:@(HGBPurchase_FILEDCOED_USERCANCEL),ReslutMessage:@"用户取消交易"}];
                break;
            }
