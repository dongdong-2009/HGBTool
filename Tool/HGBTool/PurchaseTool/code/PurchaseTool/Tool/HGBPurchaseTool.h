...
typedef NS_ENUM(NSInteger, HGBPurchaseFiledCode) {
     ...
     *  苹果返回错误信息
     */
    HGBPurchase_FILEDCOED_APPLECODE = 70,

    /**
     *  用户禁止应用内付费购买
     */
    HGBPurchase_FILEDCOED_NORIGHT = 71,

    /**
     *  商品为空
     */
    HGBPurchase_FILEDCOED_EMPTYGOODS = 72,
    /**
     *  无法获取产品信息，请重试
     */
    HGBPurchase_FILEDCOED_CANNOTGETINFORMATION =73,
    /**
     *  购买失败，请重试
     */
    HGBPurchase_FILEDCOED_BUYFILED = 74,
    /**
     *  用户取消交易
     */
    HGBPurchase_FILEDCOED_USERCANCEL = 75
